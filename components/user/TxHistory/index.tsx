            ...
            <main className="w-full mt-4">
                <Tabs defaultValue="all" className="w-full">
                    <TabsList className="w-full bg-[#F9FAFB] border-y border-[#E5E7EB] justify-start overflow-x-scroll ">
                        ...
                        <TabsTrigger className="px-3" value="subscription">Subcription</TabsTrigger>
                    ...
                    <TabsContent value="walletfunding" className="mt-8">
                        {/* walletfunding */}
                    ...
                    <TabsContent value="walletwithdrawal" className="mt-8">
                        {/* widthdrawal */}
