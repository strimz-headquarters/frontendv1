    ...
    return (
        <AlertDialog>
            <AlertDialogTrigger asChild>
                <button
                    type="button"
                    className={`w-[102px] h-[32px] flex justify-center items-center bg-[#F9FAFB] rounded-[8px] border border-[#E5E7EB] shadow-[0px_-2px_4px_0px_#00000014_inset] cursor-pointer text-[12px] font-[500] font-poppins text-strimzPrimary`}
                >
                    Cancel plan
                </button>
            </AlertDialogTrigger>
                ...
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="w-full">
                        <div className="w-full flex flex-col">
                            <h4 className="text-sm text-strimzPrimary font-[500]">You&apos;re about to cancel your subscription. Here&apos;s what you&apos;ll lose:</h4>
