    ...
    return (
        <main className="w-full flex flex-col gap-5">
            <div className="w-full flex flex-col">
                ...
                <h2 className="font-[600] font-sora capitalize text-xl text-strimzPrimary">Setup payroll</h2>
            ...
            <div className="w-full flex flex-col gap-4">
                ...
                {/* button */}
                <button onClick={handleClick} type="button" className="self-end mt-3 w-[97px] h-[40px] flex justify-center items-center rounded-[8px] bg-strimzBrandAccent text-[#FFFFFF] font-poppins font-[500] shadow-joinWaitlistBtnShadow z-10 text-shadow text-[14px] capitalize">Next</button>
            </div>
        </main>
    )
}
