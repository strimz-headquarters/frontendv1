    ...
    return (
        <section className="w-full flex flex-col gap-10">
            <div className="w-full flex flex-col">
                <button type="button" className="flex focus:outline-none focus:border-none items-center gap-1 text-strimzPrimary" onClick={() => router.back()}>
            ...
            <div className="w-full flex flex-col gap-4">
                    ...
                    <div className='w-full flex flex-col'>
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                <button
                                    className={cn(
                                        "w-full flex items-center justify-start text-left rounded-[8px] border bg-[#F9FAFB] shadow-navbarShadow h-[44px] font-poppins text-[14px] text-[#8E8C9C] px-4 outline-none transition duration-300 focus:border-strimzBrandAccent border-[#E5E7EB]"
                                    )}
                                >
                ...
                {/* button */}
                <button onClick={handleSave} type="button" className="self-end mt-3 w-[140px] h-[40px] flex justify-center items-center rounded-[8px] bg-strimzBrandAccent text-[#FFFFFF] font-poppins font-[500] shadow-joinWaitlistBtnShadow z-10 text-shadow text-[14px] capitalize">Save changes</button>
            </div>
        </section>
    )
}
