        ...
        <section className="w-full lg:pt-[64px] pt-[56px] overflow-x-hidden">
            <main className="flex flex-col items-center gap-6 z-10 bg-gradient-to-b from-[#ffffff] to-[#ffffff]/90">
                ...
                <div className="w-full flex justify-center items-center z-10 ">
                    <button type="button" onClick={() => router.push("/login")} className='w-[151px] h-[40px] flex justify-center items-center rounded-[8px] bg-strimzBrandAccent text-[#FFFFFF] font-poppins font-[600] shadow-joinWaitlistBtnShadow z-10 text-shadow text-[14px]'>
                        Launch App
                    </button>
                </div>
            </main>
