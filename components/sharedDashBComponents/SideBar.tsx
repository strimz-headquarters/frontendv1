        ...
        >
            ...
            <div className="w-full flex flex-col px-3 pb-8">
                <div className="w-full flex flex-col justify-between h-[120px] alertGradient rounded-[12px] p-4">
                    ...
                    <button type="button" onClick={() => router.push("/user/account/plan")} className="w-full h-[32px] flex justify-center items-center rounded-[8px] border border-[#E5E7EB] bg-[#F9FAFB] text-strimzPrimary text-xs">Upgrade</button>
                </div>
